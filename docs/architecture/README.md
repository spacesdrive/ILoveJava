...
Every folder has its own `README.md` — read it before adding files there. Rules are enforced by convention and code review, not tooling, until the codebase is large enough to justify lint rules for import boundaries.
