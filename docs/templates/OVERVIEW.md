...
Copy-paste starting points, kept next to the contracts they implement so they can't drift silently out of sync.

| Template                                             | Use for                       |
| ---------------------------------------------------- | ----------------------------- |
| [lesson.template.ts](lesson.template.ts)             | A new `LessonContent` entry   |
| [exercise.template.ts](exercise.template.ts)         | A new `ExerciseContent` entry |
